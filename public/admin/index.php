                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu active">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><img src="./assets/images/dashboard-admin.png" width="30" height="30" alt=""></span>
                            <span class="nxl-mtext">Dashboards</span><span class="nxl-arrow"></span>
                        </a>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="slider.html" class="nxl-link">
                            <span class="nxl-micon"><img src="./assets/images/slider-admin.png" width="30" height="30" alt=""></span>
                            <span class="nxl-mtext">Slider</span><span class="nxl-arrow"></span>
                        </a>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="daily-offer.html" class="nxl-link">
                            <span class="nxl-micon"><img src="./assets/images/daily-admin.png" width="30" height="30" alt=""></span>
                            <span class="nxl-mtext">Daily Offer</span><span class="nxl-arrow"></span>
                        </a>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><img src="./assets/images/order-admin.png" width="30" height="30" alt=""></span>
                            <span class="nxl-mtext">Orders</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="apps-chat.html">All orders</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="apps-email.html">Pending orders</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="apps-tasks.html">In process orders</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="apps-notes.html">Delivered orders</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="apps-storage.html">Declined orders</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><img src="./assets/images/product-admin.png" width="30" height="30" alt=""></span>
                            <span class="nxl-mtext">Manage Products</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="proposal.html">Product Categories</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="proposal-view.html">Products</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="proposal-edit.html">Product reviews</a></li>
                        </ul>
                    </li>
                    <!-- <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                                ...
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        <div class="avatar-text avatar-lg bg-gray-200">
                                            <img src="./assets/images/admin-cart.png" height="30" width="30" alt="">
                                        </div>
                                        <div>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        <div class="avatar-text avatar-lg bg-gray-200">
                                            <img src="./assets/images/admin-dollar.png" height="30" width="30" alt="">
                                        </div>
                                        <div>
                                            <div class="fs-4 fw-bold text-dark"><span class="counter">45</span></div>
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">Total Earnings</h3>
                                        </div>
                                    </div>
                                    <a href="javascript:void(0);" class="">
                                        <i class="feather-more-vertical"></i>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        <div class="avatar-text avatar-lg bg-gray-200">
                                            <img src="./assets/images/admin-product.png" height="30" width="30" alt="">
                                        </div>
                                        <div>
                                            <div class="fs-4 fw-bold text-dark"><span class="counter">45</span></div>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        <div class="avatar-text avatar-lg bg-gray-200">
                                            <img src="./assets/images/admin-users.png" height="30" width="30" alt="">
                                        </div>
                                        <div>
                                            <div class="fs-4 fw-bold text-dark"><span class="counter">45</span></div>
                                    ...
                                    <table class="table table-hover" id="proposalList">
                                        ...
                                        <tbody>
                                            <tr class="single-item">
                                                ...
                                                <td><a href="javascript:void(0);" class="fw-bold">1</a></td>
                                                <td><a href="javascript:void(0);">1434453</a></td>
                                                <td>
                                                ...
                                                <td><div class="badge bg-soft-success text-success">Pending</div></td>
                                                <td>
                                                    <div class="badge bg-soft-success text-success">Completed</div>
                                                </td>
                                                <td>Janaury 05, 2026</td>
                                                <td>
