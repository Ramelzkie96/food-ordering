            ...
            <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= ($currentPage == 'menu.php') ? 'active' : '' ?>" 
                       href="<?= $base_url ?>/menu.php">menu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= ($currentPage == 'chefs.php') ? 'active' : '' ?>" 
                       href="<?= $base_url ?>/chefs.php">chefs</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= in_array($currentPage, [
                        'menu_details.php','blog_details.php','cart_view.php','check_out.php','payment.php',
                        'testimonial.php','search_menu.php','404.php','faq.php','sign_in.php','sign_up.php',
                        'forgot_password.php','privacy_policy.php','terms_condition.php'
                    ]) ? 'active' : '' ?>" href="#">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= ($currentPage == 'blogs.php') ? 'active' : '' ?>" 
                       href="<?= $base_url ?>/blogs.php">blog</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="menu_icon d-flex flex-wrap">
                ...
                <li>
                    <a class="<?= ($currentPage == 'dashboard.php') ? 'active' : '' ?>" 
                       href="<?= $base_url ?>/dashboard.php"><i class="fas fa-user"></i></a>
                </li>
                <li>
